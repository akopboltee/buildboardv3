  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="max-w-2xl mx-auto px-4 py-8 flex-1 w-full">
        ...
        <p className="text-xs text-foreground/80 mb-2">Last updated: June 2026</p>
        <p className="text-xs text-foreground/80 mb-6">Contact: clarviodesigners@gmail.com</p>

        <div className="bg-muted/30 border border-border rounded-md p-4 mb-8">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <ul className="text-sm text-foreground/90 leading-relaxed list-disc pl-6">
          ...
          <section>
            ...
            <table className="text-sm text-foreground/90 w-full mt-3 border border-border">
              <thead>
          ...
          <section>
            ...
            <p className="text-sm text-foreground/90 leading-relaxed">
              Buildboard offers an "Explain This" feature powered by Groq's Llama API. This feature generates plain-language explanations of posts.
            </p>
            <ul className="text-sm text-muted-foreground leading-relaxed list-disc pl-6 mt-2">
